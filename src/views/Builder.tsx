...
export default function Builder(_props: BuilderProps) {
  ...
  return (
    <div className="min-h-full bg-background px-4 py-6 sm:px-6 lg:px-12">
      ...
      <main className="relative z-10 mx-auto flex min-h-[calc(100vh-2rem)] w-full max-w-[920px] flex-col justify-center">
        <div className="rounded-2xl border border-blueprint-line bg-card p-5 shadow-[0_20px_48px_rgba(0,0,0,0.05)] dark:shadow-[0_20px_48px_rgba(0,0,0,0.24)] sm:p-8">
          ...
          <>
              {step === 0 ? (
                <section>
                  <p className="text-ui-label text-blueprint-muted">Step 1 of 2</p>
              ...
              {step === 1 ? (
                <section>
                  <p className="text-ui-label text-blueprint-muted">Step 2 of 2</p>
              ...
              <footer className="mt-8 flex items-center justify-between border-t border-blueprint-line pt-6">
